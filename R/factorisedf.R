...
aconvertir0<-aconvertir[sapply(as.data.frame(df[,aconvertir,drop=FALSE]),nlevels)==0]
aconvertir1<-aconvertir[sapply(as.data.frame(df[,aconvertir,drop=FALSE]),nlevels)>0]
aconvertir2<-aconvertir1[sapply(as.data.frame(df[,aconvertir1,drop=FALSE]),function(l){length(unique(l))})>1]
aconvertir0<-cbind(aconvertir0,setdiff(aconvertir1,aconvertir2))
aconvertir1<-aconvertir2
